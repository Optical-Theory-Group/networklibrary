...
#     node_spec = {"S_mat_type": SM_type, "scat_loss": 0, "subunitary_factor": 1}

#     network = Network(
#         network_type, network_spec, node_spec, seed_number=seed
...
#             if isinstance(network_spec["network_size"], tuple)
#             else network_spec["network_size"]
#         )

#     plt.savefig(
#         os.path.join(
#             output_root, "network_{}{}_example.png".format(case, qualifier)
#         ),
#         dpi=300,
#     )
#     plt.savefig(
#         os.path.join(
#             output_root, "network_{}{}_example.pdf".format(case, qualifier)
#         ),
#         dpi=300,
#     )
