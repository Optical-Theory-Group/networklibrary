...
if __name__ == '__main__':
    for j in [10,20,30,40,50]:
        ...
        hdf5_filename = f'/home/baruva/scattering_data/{network_type[0:3]}_{network_shape[0:4]}/scattering_ensemble_{network_type[0:3]}_{network_shape[0:4]}_{num_external_nodes}.h5'
