...
class NetworkEnsemble():
        ...
        with h5py.File(savetofilename, 'a', driver=None) as h5file:
            ...
            for b in range(0,nbatch):
                if nbatchsize > 1:
                    ...
                    seedstorun = [initial_seed + b*nbatchsize + bb for bb in range(0,nbatchsize) if initial_seed + b*nbatchsize + bb not in existing_realisations]
    ...
    def collect_result(result):
        ...
        update_progress(progresscount / totalrealisations, '{}/{}. \n Run time {}. \n Est. time remaining  {}. \n'.format(progresscount,totalrealisations,runtime,remaintime))
